...
public class BooksFrame extends javax.swing.JFrame {
     ...
     */
    public BooksFrame() throws SQLException {
        initComponents();
        ...
        List<Sach> books = qltv.getAllBooks();
        
        for(Sach s : books)
        {
            defaultTableModel.addRow(new Object[]{s.getMaSach(),s.getTenNXB(),s.getSoBanPhatHanh(),s.getTenTacGia(),s.getSoTrang()});
        }
    }
    ...
    private void initComponents() {
        ...
        btAdd.setFont(new java.awt.Font("Segoe UI", 0, 13)); // NOI18N
        btAdd.setForeground(new java.awt.Color(255, 153, 102));
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(BooksFrame.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
